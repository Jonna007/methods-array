...
let tittleBook = prompt("Ingresa el título de un libro:");

if (programmingBooks.includes(tittleBook)) {
    alert("El libro está en la lista.");
} else {
    alert("El libro no está en la lista.");
}

let shelfIndex = programmingBooks.indexOf(tittleBook);

if (shelfIndex !== -1) {
    alert("El libro '" + tittleBook + "' se encuentra en la estantería número " + (shelfIndex + 1));
} else {
    alert("El libro '" + tittleBook + "' no se encuentra en la lista.");
}